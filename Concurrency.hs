...
sequenceComputation ::
  ...
  (Action -> Action) ->
  (Action -> Action)
sequenceComputation a b k = a (b k) -- alternatively its a1 . a2
-- remember that a1 runs before a2
...
readComputation ca = Atom (ca <$> getChar)
